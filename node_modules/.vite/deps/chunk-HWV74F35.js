import {
  require_shim
} from "./chunk-JNVCPZKD.js";
import {
  useButton
} from "./chunk-7Y5AWTYI.js";
import {
  ACTIVE_KEY,
  AnimationFrame,
  FOCUSABLE_ATTRIBUTE,
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React43 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef21 = React43.useRef, useEffect10 = React43.useEffect, useMemo19 = React43.useMemo, useDebugValue2 = React43.useDebugValue;
...
function useRole(context, props = {}) {
  ...
  const floatingId = React24.useMemo(() => getFloatingFocusElement(floatingElement)?.id || defaultFloatingId, [floatingElement, defaultFloatingId]);
...
function useDialogRoot(params) {
  ...
  const [ownNestedOpenDialogs, setOwnNestedOpenDialogs] = React29.useState(0);
  const [ownNestedOpenDrawers, setOwnNestedOpenDrawers] = React29.useState(0);
  ...
  const activeTriggerProps = React29.useMemo(() => getReferenceProps(triggerProps), [getReferenceProps, triggerProps]);
  const inactiveTriggerProps = React29.useMemo(() => getTriggerProps(triggerProps), [getTriggerProps, triggerProps]);
  const popupProps = React29.useMemo(() => getFloatingProps(), [getFloatingProps]);
  store.useSyncedValues({
    openMethod,
    activeTriggerProps,
...
var DialogRootContext = React30.createContext(void 0);
if (true) DialogRootContext.displayName = "DialogRootContext";
function useDialogRootContext(optional) {
  const dialogRootContext = React30.useContext(DialogRootContext);
...
var DialogStore = class _DialogStore extends ReactStore {
  constructor(initialState) {
    super(createInitialState(initialState), {
      ...
      backdropRef: React31.createRef(),
      internalBackdropRef: React31.createRef(),
...
var IsDrawerContext = React32.createContext(false);
...
function DialogRoot(props) {
  ...
  const isDrawer = React32.useContext(IsDrawerContext);
  ...
  return (0, import_jsx_runtime7.jsx)(IsDrawerContext.Provider, {
    value: false,
    children: (0, import_jsx_runtime7.jsx)(DialogRootContext.Provider, {
      value: contextValue,
...
var DialogBackdrop = React33.forwardRef(function DialogBackdrop2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var DialogClose = React34.forwardRef(function DialogClose2(componentProps, forwardedRef) {
  const {
    render,
    className,
    disabled = false,
...
var DialogDescription = React35.forwardRef(function DialogDescription2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var DialogPortalContext = React36.createContext(void 0);
if (true) DialogPortalContext.displayName = "DialogPortalContext";
function useDialogPortalContext() {
  const value = React36.useContext(DialogPortalContext);
  if (value === void 0) {
...
var DialogPopup = React37.forwardRef(function DialogPopup2(componentProps, forwardedRef) {
  const {
    className,
    finalFocus,
    initialFocus,
...
var InternalBackdrop = React38.forwardRef(function InternalBackdrop2(props, ref) {
  const {
    cutout,
    ...otherProps
  } = props;
...
var DialogPortal = React39.forwardRef(function DialogPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
...
var DialogViewport = React42.forwardRef(function DialogViewport2(componentProps, forwardedRef) {
  const {
    className,
    render,
    children,
...
//# sourceMappingURL=chunk-HWV74F35.js.map
